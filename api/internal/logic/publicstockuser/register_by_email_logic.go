...
func (l *RegisterByEmailLogic) RegisterByEmail(req *types.StockUserRegisterByEmailReq) (resp *types.BaseMsgResp, err error) {
	...
	if captchaData == req.Captcha {
		_, err := l.svcCtx.CoreRpc.CreateStockUser(l.ctx,
			&core.StockUserInfo{
